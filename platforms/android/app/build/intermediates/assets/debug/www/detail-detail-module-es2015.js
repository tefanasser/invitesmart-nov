...
let DetailPage = class DetailPage {
    constructor(platform, userService, translate, socialSharing, modalController) {
    ...
    shareImage() {
        ...
        setTimeout(() => dom_to_image__WEBPACK_IMPORTED_MODULE_3___default.a.toPng(this.container.nativeElement)
            .then(dataUrl => {
            var img = new Image();
            img.src = dataUrl;
            this.imgUrl = img.src;
